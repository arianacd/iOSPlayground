...
var favoriteBook = Book(title: "On the Fence", author: "Kasie West", pages: 132, price: 8.7)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It is \(favoriteBook.pages) pages long and costs $ \(favoriteBook.price) ")
/*:
...
var myHeightinch = Height(heightInCentimeters: 170.18)
print(myHeightinch.heightInInches)
