 ...
 */
firstRun.distence = 2396
firstRun.time = 15.3
firstRun.elevation = 94
print("Today I ran \(firstRun.distence) meters in \(firstRun.time) minutes and gain \(firstRun.elevation) meters of elevation.")
