 ...
 */
var ariana = User(name: "Ariana", age: 16, height: 67.0, weight: 130.0, activityLevel: 3)
print("Hello, my name is \(ariana.name) and I am \(ariana.age) years old. I am \(ariana.height) inches tall, weight \(ariana.weight) pounds, amd have an activity level of \(ariana.activityLevel)")
