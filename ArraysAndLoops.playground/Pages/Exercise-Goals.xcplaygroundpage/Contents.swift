...
*/
let minutesHomework = [30, 60, 20, 25, 37, 42, 64, 70, 90, 55, 67, 24, 78, 92, 43, 17, 23, 111, 100, 60]
...
func goal (dailynumber: Int){
    if dailynumber >= 45{
        print("too much homework")
    }
    else{
        print("not too bad")
    }
...
for minute in minutesHomework{
    goal(dailynumber: minute)
}
