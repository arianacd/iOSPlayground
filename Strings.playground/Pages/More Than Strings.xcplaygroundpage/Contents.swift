...
let noun = "cat"
let place = "classroom"
let posativeEmotion = "happy"
let negativeEmotion = "feckless"

let sentence = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(posativeEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)."
