...
let beliefs = impossibleBeliefsCount(pigsFlying: 2, frogsBecomingPrinces: 2, multipleLightningStrikes: 2)
impossibleThingsPhrase(numberOfImpossibleThings: beliefs, meal: "teatime")
