...
*/
func printFavorite(category: String, favorite: String) -> String {
    return ("My favorite " + category + " is " + favorite)
}

let favoriteFood = printFavorite(category: "dinner", favorite: "burgers")
print(favoriteFood)
...
let favoriteMovie = printFavorite(category: "movie", favorite: "good will hunting")
print(favoriteMovie)

let favoriteDessert = printFavorite(category: "dessert", favorite: "chacolate lava cake")
print(favoriteDessert)
...
"Hello, my name is Ariana. \(favoriteMovie). \(favoriteFood). \(favoriteDessert)"
